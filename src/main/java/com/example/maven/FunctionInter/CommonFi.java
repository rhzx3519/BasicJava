package com.example.maven.FunctionInter;
...
public class CommonFi {
    ...
    public static void main(String[] args) {
        ...
        UnaryOperator<String> unary = (x) -> {System.out.println(x + ": "); return "Unary";};
        System.out.println(unary.apply("hello unary"));
    }
}
